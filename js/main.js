...
(function(){
    var appendCoderwallBadge = function(){
        var coderwallJSONurl ="https://coderwall.com/pingfengluo.json?callback=?"
          , size = 32
          ;
        ...
        $.getJSON(coderwallJSONurl, function(data) {
            $.each(data.data.badges, function(i, item){
                var a = $("<a>")
                    .attr("href", "http://www.coderwall.com/pingfengluo/")
                    .attr("target", "_blank")
                    ;
                ...
                $("<img>").attr("src", item.badge)
                    ...
                    .click( function(){ window.location = "http://www.coderwall.com/pingfengluo/"; })
                    .appendTo(a)
                    ;
                $("#coderwall").append(a);
            });
